...
I did this in https://github.com/jdreaver/kernel-dev (I had a working setup
before I did Eudalypta).

- Built custom deb QEMU image with `debootstrap`
- Fetch git kernel from Torvalds tree
- Used `make menuconfig`, pressed `/` and found `CONFIG_LOCALVERSION_AUTO`,
  ensured it was set to `y`
- Ran `make -j32`
- Booted with QEMU using something like
...
```
Debian GNU/Linux 10 arnor ttyS0

arnor login: root
Linux arnor 5.19.0-rc3-00336-g0840a7914caa #1 SMP PREEMPT_DYNAMIC Sun Jun 26 07:41:23 PDT 2022 x86_64
...
root@arnor:~# uname -r
5.19.0-rc3-00336-g0840a7914caa
```
